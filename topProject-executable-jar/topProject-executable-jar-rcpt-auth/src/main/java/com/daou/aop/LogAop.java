...
/*
 	...
 	execution(* com.daou.*.*()) com.daou 패키지에 파라미터가 없는 모든 메서드 호출
 	execution(* com.daou..*.*(..)) com.daou 패키지 및 하위 패키지에 있는 파라미터가 0개 이상인 메서드 호출
 */
...
public class LogAop {
	...
	@Around("execution(public * com.daou..*.*(..))")
